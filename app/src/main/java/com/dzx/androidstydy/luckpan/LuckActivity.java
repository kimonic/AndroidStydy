package com.dzx.androidstydy.luckpan;
...
import com.dzx.androidstydy.luckpan.view.EnvironmentLayout;
import com.dzx.androidstydy.luckpan.view.LuckPanLayout;
import com.dzx.androidstydy.luckpan.view.RotatePan;


public class LuckActivity extends AppCompatActivity implements RotatePan.AnimationEndListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        luckPanLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                MinValue -= Util.dip2px(LuckActivity.this,10)*2;
                ...
                MinValue -= Util.dip2px(LuckActivity.this,28)*2;
